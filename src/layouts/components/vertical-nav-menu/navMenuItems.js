...
export default [
  ...
  //////////////// Admin /////////////////////////
  {
    header: "Điều khiển hệ thống",
    icon: "SettingsIcon",
    i18n: "Điều khiển hệ thống",
    rule: "admin",
    items: [
      {
        url: "/admin/dieukhienhethong/duyetnaptien",
        name: "duyetnaptien",
        slug: "lead-duyetnaptien",
        icon: "CornerRightDownIcon",
        i18n: "Duyệt Nạp Tiền",
      },
      {
        url: "/admin/dieukhienhethong/duyetruttien",
        name: "duyetruttien",
        slug: "lead-duyetruttien",
        icon: "CornerRightUpIcon",
        i18n: "Duyệt Rút Tiền",
      },
      {
        url: "/admin/dieukhienhethong/duyetmuabot",
        name: "duyetmuabot",
        slug: "lead-duyetmuabot",
        icon: "AirplayIcon",
        i18n: "Duyệt Cấu Hình Bot",
      },
    ]
  },
  // Thong ke
  ...
  //////////////// Supper Admin /////////////////////////
  {
    ...
    items: [
      {
        url: "/superadmin/quantri/hethong",
        name: "superadmin-hethong",
        slug: "superadmin-hethong",
        icon: "ServerIcon",
        i18n: "Duyệt Cấu Hình Bot",
      },
    ]
