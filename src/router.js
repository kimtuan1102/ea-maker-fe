    ...
    routes: [

        {
            ...
            children: [
                ...
                {
                    path: '/lead',
                    redirect: '/lead/dichvu/naptien'
                },
                {
                    path: '/lead/dichvu/naptien',
                    name: 'dichvu-naptien',
                    component: () => import('./views/lead/dichvu/DichVuNapTien.vue'),
                    meta: {
                        rule: 'lead',
                    }
                },
                ...
                {
                    path: '/lead/dichvu/muabot',
                    name: 'dichvu-muabot',
                    component: () => import('./views/lead/dichvu/DichVuMuaBot.vue'),
                    meta: {
                        rule: 'lead',
                    }
                },
                {
                    path: '/lead/dichvu/ruttien',
                    name: 'dichvu-ruttien',
                    component: () => import('./views/lead/dichvu/DichVuRutTien.vue'),
                    meta: {
                        rule: 'lead',
                    }
                },
                // THong ke
                {
                    path: '/lead/thongke',
                    name: 'thongke',
                    component: () => import('./views/lead/thongke/ThongKe.vue'),
                    meta: {
                        rule: 'lead',
                    }
                },
                ...
                {
                    path: '/admin',
                    redirect: '/admin/dieukhienhethong/duyetnaptien'
                },
                {
                    path: '/admin/dieukhienhethong/duyetnaptien',
                    name: 'dieukhienhethong-naptien',
                    component: () => import('./views/admin/dieukhienhethong/DuyetNapTien.vue'),
                    meta: {
                        rule: 'admin',
                    }
                },
                {
                    path: '/admin/dieukhienhethong/duyetruttien',
                    name: 'dieukhienhethong-duyetruttien',
                    component: () => import('./views/admin/dieukhienhethong/DuyetRutTien.vue'),
                    meta: {
                        rule: 'admin',
                    }
                },
                {
                    path: '/admin/dieukhienhethong/duyetmuabot',
                    name: 'dieukhienhethong-duyetmuabot',
                    component: () => import('./views/admin/dieukhienhethong/DuyetMuaBot.vue'),
                    meta: {
                        rule: 'admin',
                    }
                },
                ...
                {
                    path: '/superadmin',
                    redirect: '/superadmin/quantri/hethong'
                },
                {
                    path: '/superadmin/quantri/hethong',
                    name: 'quantri-goi',
                    component: () => import('./views/superadmin/quantri/DuyetMuaBot.vue'),
                    meta: {
                        rule: 'superadmin',
                    }
                },
                {
                    path: '/superadmin/thongke',
                    name: 'superadmin-thongke',
                    component: () => import('./views/superadmin/thongke/ThongKe.vue'),
                    meta: {
                        rule: 'superadmin',
                    }
                },
                ...
                // Manager EA
                {
                    ...
                    //redirect: '/dashboard/analytics',
                    name: 'ea',
                    component: () => import('./views/ea/ListEA.vue'),
                    meta: {
                        rule: 'admin',
                    }
                },
