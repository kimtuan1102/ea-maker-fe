                ...
                <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <template class="expand-user" slot="expand">
                        <div class="con-expand-users">
                            ...
                            <vs-list>
                                <vs-list-item icon="mail" title="Email" subtitle="iii"></vs-list-item>
...
export default {
    ...
    computed: {
        ...
        dataTransactions() {
            //loc mua goi
            return this.$store.state.dataAdmin.dataTransactions.filter(c => c.type == 3)
        },
        queriedItems() {
    ...
    methods: {
        ...
        approveItem(id, idUser) {
            ...
            this.$store.dispatch("dataAdmin/completeBot", id).then((response) => {
